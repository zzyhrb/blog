...
public class ProjectAutoUtil2 {
	...
	public static List<Map<String,String>> loadTable() {
		try {
			...
			Connection connection = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/blog?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull", "root","root");
	...
	public static void main(String[] args) throws IOException {
		...
		String pojo = "src/main/java/com/zzy/blog/pojo";
		loadTemplate(maps,pojo,beanModel+".java","pojo.tml");
		
		String mapper = "src/main/java/com/zzy/blog/mapper";
		...
		//service
		String service = "src/main/java/com/zzy/blog/service/"+model;
		loadTemplate(maps,service,"I"+beanModel+"Service.java","service.tml");
		String serviceimpl = "src/main/java/com/zzy/blog/service/"+model;
		loadTemplate(maps,serviceimpl,beanModel+"ServiceImpl.java","serviceImpl.tml");
		
		//vo
		String vo = "src/main/java/com/zzy/blog/vo";
		loadTemplate(maps,vo,beanModel+"Vo.java","vo.tml");
		
		//controller
		String controller = "src/main/java/com/zzy/blog/controller/"+model;
...
//
//		//listtag
//		String listtag = "src/main/java/com/zzy/blog/tag/"+model;
//		loadTemplate(maps,listtag,beanModel+"ListTag.java","listtag.tml");
//
//		//benatag
//		String benatag = "src/main/java/com/zzy/blog/tag/"+model;
